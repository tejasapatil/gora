...
import org.apache.voldemort.core.Constants;
import org.apache.voldemort.core.client.VoldemortException;
import org.apache.voldemort.core.client.VoldemortSecurityException;
import org.apache.voldemort.core.client.BatchWriter;
import org.apache.voldemort.core.client.Connector;
import org.apache.voldemort.core.client.IsolatedScanner;
import org.apache.voldemort.core.client.IteratorSetting;
import org.apache.voldemort.core.client.MutationsRejectedException;
import org.apache.voldemort.core.client.RowIterator;
import org.apache.voldemort.core.client.Scanner;
import org.apache.voldemort.core.client.TableDeletedException;
import org.apache.voldemort.core.client.TableExistsException;
import org.apache.voldemort.core.client.TableNotFoundException;
import org.apache.voldemort.core.client.TableOfflineException;
import org.apache.voldemort.core.client.ZooKeeperInstance;
import org.apache.voldemort.core.client.impl.Tables;
import org.apache.voldemort.core.client.impl.TabletLocator;
import org.apache.voldemort.core.client.mock.MockConnector;
import org.apache.voldemort.core.client.mock.MockInstance;
import org.apache.voldemort.core.client.mock.MockTabletLocator;
import org.apache.voldemort.core.data.ByteSequence;
import org.apache.voldemort.core.data.Key;
import org.apache.voldemort.core.data.KeyExtent;
import org.apache.voldemort.core.data.Mutation;
import org.apache.voldemort.core.data.Range;
import org.apache.voldemort.core.data.Value;
import org.apache.voldemort.core.iterators.SortedKeyIterator;
import org.apache.voldemort.core.iterators.user.TimestampFilter;
import org.apache.voldemort.core.master.state.tables.TableState;
import org.apache.voldemort.core.security.ColumnVisibility;
import org.apache.voldemort.core.security.thrift.AuthInfo;
import org.apache.voldemort.core.util.Pair;
import org.apache.voldemort.core.util.TextUtil;
import org.apache.voldemort.core.util.UtilWaitThread;
...
import org.apache.gora.voldemort.query.VoldemortQuery;
import org.apache.gora.voldemort.query.VoldemortResult;
...
public class VoldemortStore<K,T extends PersistentBase> extends DataStoreBase<K,T> {
  ...
  protected static final String MOCK_PROPERTY = "voldemort.mock";
  ...
  private VoldemortMapping mapping;
  ...
  public void initialize(Class<K> keyClass, Class<T> persistentClass, Properties properties) {
    try{
      ...
      if (mapping.encoder == null || mapping.encoder.equals("")) {
        encoder = new org.apache.gora.voldemort.encoders.BinaryEncoder();
      } else {
        try {
      ...
      try {
        ...
        throw new IOException(e);
      } catch (VoldemortSecurityException e) {
        throw new IOException(e);
      }
    }catch(IOException e){
  ...
  protected VoldemortMapping readMapping(String filename) throws IOException {
    try {
      
      VoldemortMapping mapping = new VoldemortMapping();
      ...
      if (mapping.tableName == null) {
        throw new GoraException("Please define the gora to voldemort mapping in " + filename + " for " + persistentClass.getCanonicalName());
      }
  ...
  public void put(K key, T val) {
    ...
    try{
      ...
      for (int i = 0; iter.hasNext(); i++) {
        ...
        if (col == null) {
          throw new GoraException("Please define the gora to voldemort mapping for field " + field.name());
        }
  ...
  public Result<K,T> execute(Query<K,T> query) {
    try {
      Scanner scanner = createScanner(query);
      return new VoldemortResult<K,T>(this, query, scanner);
    } catch (TableNotFoundException e) {
  ...
  public Query<K,T> newQuery() {
    return new VoldemortQuery<K,T>(this);
  }
  ...
  public List<PartitionQuery<K,T>> getPartitions(Query<K,T> query) throws IOException {
    try {
      ...
      //hadoop expects hostnames, voldemort keeps track of IPs... so need to convert
